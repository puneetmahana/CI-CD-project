package com.Puneet.Docker.DockerSpringboot.controller;
...
public class WebController {
    ...
    public ResponseEntity<String> findMovieById(@RequestParam String key){
        redisRepository.findMovieById(key);
        return new ResponseEntity<>(HttpStatus.OK);
    }
